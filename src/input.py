...
# df_pos.shape is (1813, 58), 1/2(1812) = 906
# df_neg.shape is (2788, 58), 1/2(2788) = 1394
...
# training data
# take half of positive and half of negative instances
frames_training = [df_pos[0:906], df_neg[0:1394]]
df_training = pd.concat(frames_training)
df_training = df_training.reset_index(drop=True)

# split by pos and neg to get means and standard deviations
...
# test data
# take half-1 of positive (for even division) and half of negative instances
frames_test = [df_pos[906:1812], df_neg[1394:2788]]
df_test = pd.concat(frames_test)
df_test = df_test.reset_index(drop=True)

# df_training size is (2300, 58)
# df_test size is (2300, 58)

# convert dataframes into numpy matrices
...
# will use classifier data (1 or 0) in naive bayes
# to compute accuracy, precision, and recall (using false pos and false neg)
